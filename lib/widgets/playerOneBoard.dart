  ...
  Widget brick(BuildContext context, int index) {
    ...
    return GetBuilder(
      ...
      builder: (_) => FButton(
        ...
        image: playerOneGameModel.listOffColorsAndBool[index][2] == "true"
            ? Container(
                child: Icon(
        ...
        clickEffect: true,
        color: playerOneGameModel.listOffColorsAndBool[index][1] == "true"
            ? HexColor(playerOneGameModel.listOffColorsAndBool[index][0])
            : HexColor(mainBackgroundColor),
        shadowColor: mainShadowColor,
        strokeColor: HexColor(mainBackgroundColor),
        strokeWidth: playerOneGameModel.listOffColorsAndBool[index][2] == "true"
            ? 0.0
            : 1.0,
        width: 190,
        height: 60,
